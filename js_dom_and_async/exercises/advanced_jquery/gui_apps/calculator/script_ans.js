var App = {
  ...
  // clear both operations and current number parts of screen
  clearAll: function(e) {
    this.clear(e);
    this.clearOpScreen();
    this.reset();
  ...
  // handle click on '.' button. If there's '.' on current number screen don't
  ...
  // concatenate current number and operator to operations screen
  ...
  bind: function() {
    ...
    document.querySelector('.result_button')
      .addEventListener('click', this.handleResClick.bind(this));
    document.querySelector('#neg')
      .addEventListener('click', this.negateNum.bind(this));
    ...
    document.querySelector('.dot')
      .addEventListener('click', this.handleDotClick.bind(this));
  },
